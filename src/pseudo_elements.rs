...
pub static LEVEL_ONE_AND_TWO_PSEUDO_ELEMENTS: LazyLock<AHashSet<&'static str>> =
    LazyLock::new(|| {
...
pub static LEVEL_THREE_AND_UP_PSEUDO_ELEMENTS: LazyLock<AHashSet<&'static str>> =
    LazyLock::new(|| {
...
pub static SHADOW_TREE_PSEUDO_ELEMENTS: LazyLock<AHashSet<&'static str>> = LazyLock::new(|| {
...
pub static WEBKIT_SCROLLBAR_PSEUDO_ELEMENTS: LazyLock<AHashSet<&'static str>> =
    LazyLock::new(|| {
...
pub static VENDOR_SPECIFIC_PSEUDO_ELEMENTS: LazyLock<AHashSet<&'static str>> =
    LazyLock::new(|| {
